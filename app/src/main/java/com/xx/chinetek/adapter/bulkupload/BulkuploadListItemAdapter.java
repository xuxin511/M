package com.xx.chinetek.adapter.bulkupload;
...
public class BulkuploadListItemAdapter extends BaseAdapter implements Filterable {
    private BulkuploadListItemAdapter.ArrayFilter mFilter;
    ...
    public Filter getFilter() {
        if (mFilter == null) {
            mFilter = new BulkuploadListItemAdapter.ArrayFilter();
        }
        return mFilter;
    }
