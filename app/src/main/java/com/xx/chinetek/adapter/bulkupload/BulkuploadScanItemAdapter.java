...
public class BulkuploadScanItemAdapter extends BaseAdapter {
    ...
    public BulkuploadScanItemAdapter(Context context, ArrayList<DNDetailModel> dnDetailModels, Integer SOURCE) {
        dnsource=SOURCE;
